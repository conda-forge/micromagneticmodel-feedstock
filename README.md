About micromagneticmodel-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/micromagneticmodel-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3090&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/micromagneticmodel-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `micromagneticmodel` can be installed with `conda`:
...
```
mamba install micromagneticmodel
```

It is possible to list all of the versions of `micromagneticmodel` available on your platform with `conda`:
...
```
mamba search micromagneticmodel --channel conda-forge
```
...
mamba repoquery search micromagneticmodel --channel conda-forge

# List packages depending on `micromagneticmodel`:
mamba repoquery whoneeds micromagneticmodel --channel conda-forge

# List dependencies of `micromagneticmodel`:
mamba repoquery depends micromagneticmodel --channel conda-forge
```
